                        ...
                        <div class="nov-modules col-lg-12 col-md-12 ">
                            <div class="block nov-wrap">
                                ...
                                <div class="block_newsletter">
                                    <form action="http://demo.bestprestashoptheme.com/savemart/en/#footer"
                                          method="post">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="http://demo.bestprestashoptheme.com/savemart/en/"
                                                      method="post">
                                                    <div class="subscribe_form d-flex justify-content-start ">
                                                        <div class="inner">
                                                            <div class="title_block">Sign up to Newsletter</div>
                                                            <p>Receive email-only deals, special offers &amp; product
                                                                exclusives</p>
